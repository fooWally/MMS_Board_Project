...
insert into member3 (id, pw, name, birth, email) values('test1', 'asdf', '안경수', '14/Sep/1999', 'rud@naver.com')
...
insert into member3 values('m005', 'dddd', '홍길동', '13-Sep-1970', 'abc@mbc.net')
insert into member3 values('m006', 'aaaa', '아무개', '08-Jan-1999', 'dada@abc.com')
...
insert into member3 values('m005', '홍길동', 'dddd', '13-Sep-1970', 'abc@mbc.net')
insert into member3 values('m006', '아무개', 'aaaa', '08-Jan-1999', 'dada@abc.com')
